...
184          * }<br />.
    ...
    LuShu.prototype.currentP = null;
    LuShu.prototype.before_submit = function(){
        this.currentP = this._path[i];
        pause();
    ...
    // 自己添加的类 todo
    // @description 接收来自已经更新的路径，设置新的路径
    // @param route
    LuShu.prototype.re_route = function(route){
        var me = this;
        // 更新路径
        me._path = route;
        me.i = 0;
